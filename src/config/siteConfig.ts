...
export const siteConfig: SiteConfig = {
	title: "NeutronStar", // 站点名称（浏览器标签页/SEO 标题）
	subtitle: "星舰 AI 博客 · 深空中的思考", // 站点副标题/描述
	siteURL: "https://blog.neutronstar.fun/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-08-18", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	navbarTitle: {
		...
		mode: "text-icon",
		// 顶栏标题文本（左侧 Logo 文字，显示为 NeutronStar）
		text: "NeutronStar",
